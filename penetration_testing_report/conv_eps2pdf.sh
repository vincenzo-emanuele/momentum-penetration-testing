...
# Si filtrano tutti i file nella directory affinch� siano dei eps con estensione ".eps"
...
# Si filtrano tutti i file nella directory affinch� siano dei pdf con estensione ".pdf"
